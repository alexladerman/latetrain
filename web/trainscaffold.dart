...
@CustomTag('train-scaffold')
class TrainScaffold extends HtmlElement with DomProxyMixin {
  TrainScaffold.created() : super.created();
...
@initMethod
upgradeTrainScaffold() => registerDartType('train-scaffold', TrainScaffold);
